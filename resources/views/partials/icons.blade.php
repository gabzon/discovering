    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 text-center">
        <div class="service-box mt-5 mx-auto">
          <a href="{{ get_permalink( get_page_by_title( 'explora' ) ) }}" class="grow dib">
      ...
      <div class="col-lg-3 col-md-6 text-center">
        <div class="service-box mt-5 mx-auto">
          <a href="{{ get_permalink( get_page_by_title( 'transporte' ) ) }}" class="grow dib">
            <i class="fa-4x fas fa-building text-primary mb-3 sr-icons"></i>
          </a>
          <a href="{{ get_permalink( get_page_by_title( 'transporte' ) ) }}" class="grow dib link no-underline">
      ...
      <div class="col-lg-3 col-md-6 text-center">
        <div class="service-box mt-5 mx-auto">
          <a href="{{ get_permalink( get_page_by_title( 'informacion turistica' ) ) }}" class="grow dib">
